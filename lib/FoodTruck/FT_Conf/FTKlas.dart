// FTKlas.dart
// Defines data models for the Food Truck app: LMItm (menu item), FTPax (food truck packages), and FTDat (all food trucks and packages).
  ...
  final List<FTPax> ft = [
      ...
      pax: {
        'Grill Master\'s Feast': [
          ...
          LMItm(
              ...
              prois: 12.00),
          LMItm(
              title: 'Baked Potato with Cheese and Beef',
              desc: 'Hearty side dish',
      ...
      pax: {
        'Indian Spice Sensation': [
          LMItm(
              ...
              desc: 'Creamy and flavorful',
              img: 'butter_chicken.png',
              prois: 15.00),
          LMItm(
              title: 'Vegetable Samosas',
              desc: 'Crispy and savory',
              img: 'samosas.png',
              prois: 5.00),
          LMItm(
              title: 'Chana Masala with Rice',
              desc: 'Hearty and spicy',
              img: 'chana_masala.png',
              prois: 10.00),
          LMItm(
              title: 'Mango Lassi',
        ...
        'Spicy Thai Delight': [
          ...
          LMItm(
              ...
              img: 'spring_rolls.png',
              prois: 4.00),
          LMItm(
              title: 'Thai Iced Tea',
              desc: 'Sweet and refreshing',
              img: 'thai_iced_tea.png',
              prois: 3.00),
        ],
      },
    ),
    FTPax(
      ...
      pax: {
        ...
        'Mini Dessert Sampler': [
          LMItm(
              title: 'Assorted Mini Cupcakes',
              desc: 'Colorful and tasty',
              img: 'mini_cupcakes.png',
              prois: 8.00),
          LMItm(
              title: 'Mini Cheesecake',
              desc: 'Creamy and delicious',
              img: 'mini_cheesecake.png',
              prois: 6.00),
          LMItm(
              title: 'Macarons',
              desc: 'French delicacy',
              img: 'macarons.png',
              prois: 10.00),
          LMItm(
              title: 'Fruit Tarts',
              desc: 'Fresh and fruity',
              img: 'fruit_tarts.png',
              prois: 7.00),
        ],
      },
    ...
    FTPax(
      ...
      pax: {
        'Asian Fusion Feast': [
          LMItm(
              title: 'Stir-Fried Noodles with Chicken and Vegetables',
              desc: 'Flavorful and healthy',
              img: 'stir_fry_noodles.png',
              prois: 12.00),
          LMItm(
        ...
        'Spicy Noodle Sensation': [
          LMItm(
              ...
              desc: 'Vegetarian delight',
              img: 'pad_thai_tofu.png',
              prois: 10.00),
          LMItm(
              title: 'Spicy Ramen',
              desc: 'Flavorful and spicy',
              img: 'spicy_ramen.png',
              prois: 8.00),
          LMItm(
              title: 'Gyoza', desc: 'Dumplings', img: 'gyoza.png', prois: 6.00),
          LMItm(
              title: 'Green Tea',
              desc: 'Refreshing drink',
              img: 'green_tea.png',
